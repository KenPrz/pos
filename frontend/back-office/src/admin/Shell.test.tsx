...
// stubbed out here so this file only exercises the shell/nav rebuild itself. TodaySection
// is deliberately left real: it's the thing that proves gated widgets never fire a
// request for a permission the session doesn't hold (RBAC v2 Task 11).
...
const LOW_STOCK_ROWS: StockReportRow[] = [
